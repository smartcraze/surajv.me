...
function HeroSection() {
  ...
  return (
    <div id="home" className="h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
      <Spotlight
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        <div className="mt-4 flex items-center justify-center">
          ...
          <Link href={"https://github.com/smartcraze"} target="_blank" className="mx-2">
          <Button
            borderRadius="1.75rem"
